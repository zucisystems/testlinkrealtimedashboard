...
if ($pro=mysql_num_rows($result) ==0) 
{
    ...
    while($row=mysql_fetch_assoc($result)) {
	   ...
	   $row1=mysql_fetch_assoc($result1);
		...
		$sql4e="SELECT execution_type,id from tcversions where id='".$row7['tcversion_id']."' and execution_type='1' ";	
        ...
        FROM `executions` where testplan_id='".$row1['id']."'and tcversion_id= '".$row4e['id']."' ORDER BY execution_ts DESC LIMIT 50 )r 
